...
var orderLayers = function() {
	var orderClass = ['server','table','external_wall','internal_wall','stair','door','window','graphNode','graphArc','path','CellaFrigo','TavoloAutoptico','CoffinStorage','BarellaElettrica','Evaporatore','BancoLavandino','WallSluice'];
