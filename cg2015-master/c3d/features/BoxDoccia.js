...
Feature.inherits(BoxDoccia, Feature);

function BoxDoccia(feature) {
	Feature.call(this, feature);
}

BoxDoccia.prototype.style = {
			    			prefix: "fa",
	    					icon: "minus",
	    					zIndex: 3
						};

BoxDoccia.prototype.in_graph = true;

BoxDoccia.prototype.in_2D_map = true;

BoxDoccia.prototype.get3DModel = function() {
