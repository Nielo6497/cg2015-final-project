...
var inputPaths = {
	config: __dirname + '/../json_input/Mortuary/config.json',
	architecture: __dirname + '/../json_input/Mortuary/architecture.json',
	furniture: __dirname + '/../json_input/Mortuary/furnitures_officewaiting.json'
};
